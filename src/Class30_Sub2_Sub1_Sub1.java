...
return;
        ...
        if(s.startsWith("mapback"))
            try
            {
                Image image5 = Toolkit.getDefaultToolkit().getImage((new StringBuilder()).append(signlink.findcachedir() +"/Sprites/").append(s).append(" ").append(i).append(".png").toString());
anInt1440 = class52.mapbackw;
anInt1441 = class52.mapbackh;
...
try
{
Image image = Toolkit.getDefaultToolkit().getImage(signlink.findcachedir() +"/Sprites/BACKTOP1 0.png");
anIntArray1439 = new int[anInt1440 * anInt1441];
PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
pixelgrabber.grabPixels();
...
try
{
Image image = Toolkit.getDefaultToolkit().getImage(signlink.findcachedir() +"/Sprites/BACKVMID1 0.png");
anIntArray1439 = new int[anInt1440 * anInt1441];
anInt1440 = class52.mapbackleftw;
anInt1441 = class52.mapbacklefth;
...
try
{
Image image = Toolkit.getDefaultToolkit().getImage(signlink.findcachedir() +"/Sprites/BACKVMID2 0.png");
anIntArray1439 = new int[anInt1440 * anInt1441];
PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
pixelgrabber.grabPixels();
...
try
{
anInt1440 = class52.mapbackrightw;
anInt1441 = class52.mapbackrighth;
Image image = Toolkit.getDefaultToolkit().getImage(signlink.findcachedir() +"/Sprites/BACKRIGHT1 0.png");
anIntArray1439 = new int[anInt1440 * anInt1441];
PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
pixelgrabber.grabPixels();
...
try
{
Image image = Toolkit.getDefaultToolkit().getImage(signlink.findcachedir() +"/Sprites/BACKRIGHT2 0.png");
anIntArray1439 = new int[anInt1440 * anInt1441];
PixelGrabber pixelgrabber = new PixelGrabber(image, 0, 0, anInt1440, anInt1441, anIntArray1439, 0, anInt1440);
pixelgrabber.grabPixels();
...
System.out.println(((Object) (exception)));
        ...
        if(s.equalsIgnoreCase("miscgraphics") && i == 3)
            try
            {
                Image image3 = Toolkit.getDefaultToolkit().getImage(signlink.findcachedir() +"/Sprites/MiscGraphics_3.png");
                anIntArray1439 = new int[anInt1440 * anInt1441];
