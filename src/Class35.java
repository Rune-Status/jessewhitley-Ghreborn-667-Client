...
public final class Class35
{
    ...
    public static String method525(int i, boolean flag, Stream class30_sub2_sub2)
    {
        int j = 0;
        int k = -1;
        for(int l = 0; l < i; l++)
    ...
    public static void method526(String s, boolean flag, Stream class30_sub2_sub2)
    {
        if(s.length() > 80)
            s = s.substring(0, 80);
        s = s.toLowerCase();
    ...
    private static Stream aClass30_Sub2_Sub2_632 = new Stream(new byte[100], 891);
