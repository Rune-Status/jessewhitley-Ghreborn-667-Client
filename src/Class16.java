public class Class16
{
    ...
    public static final void method240(int i, Stream class30_sub2_sub2)
    {
        aByteArray327 = new byte[0x6baa8];
        aClass30_Sub2_Sub2_328 = new Stream(aByteArray327, 891);
        if(i != 0)
    ...
    private final void method242(boolean flag, Stream class30_sub2_sub2)
    {
        for(int i = 0; i < 10; i++)
        {
